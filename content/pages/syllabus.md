...
2.  {{% resource_link "1847135d-3b0a-46d1-94b5-a54507704017" "![Buy at MIT Press](/images/mp_logo.gif)" %}} Roads, C. {{% resource_link "1847135d-3b0a-46d1-94b5-a54507704017" "_The Computer Music Tutorial_" %}}. Cambridge, MA: MIT Press, 1996. ISBN: 9780262680820.
...
Digital media assignments, when required, must be submitted (if smaller than 5 MB) via email attachment or (if larger than 5 MB) via a digital delivery service like Pando (free {{% resource_link "d6a1748b-06a1-4c68-9009-5a70ce200ad3" "Basic Version" %}}) or YouSendIt (free Lite {{% resource_link "546ec896-a1d3-4150-9585-34dad5556245" "account" %}}). Upon receipt by the instructor students will receive an email confirmation within twelve hours. If a student does not receive email confirmation, it is the student's responsibility to contact the instructor and/or re-send the assignment. All digital media assignments must be submitted as MIDI (.mid), AIFF (.aif), or WAVE (.wav) files.
...
Grading policies, the use of grade modifiers, and additional grades will be given in accordance with policies set forth in the MIT Course Bulletin, {{% resource_link "95b5305c-5b8b-4a86-8bfa-21952779ebdc" "Academic Procedures and Institute Regulations." %}}
...
Suspected cases of academic misconduct will be handled according to section 10.2 of {{% resource_link "1ec4bd4c-f909-451c-8f85-1a6034b656f3" "MIT Policies and Procedures" %}}.
